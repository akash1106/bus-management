...
insert into traver_details(bid,uid,seatno,active)
values(1,1,"a1",0),
(2,2,"b3",0),
(3,3,"c5",1),
(4,4,"d7",1),
...
select bid,start,end,btype,rating,atime,dtime,ac_nonac
from bus_details
where start="trichy" and end="chennai";

-- command 2 

select u.uid,b.bid,b.seatno
from user_details as u natural join traver_details as b
where u.uid=2;

-- commmand 3

select u.fname,t.seatno
from (user_details as u natural join traver_details as t) natural join bus_details as b
where  b.bid=1;
